...
/*
 * [11-13] 다음 코드는 문제11-12를 발전시킨 것으로 각 Player들의 점수를 계산하고, 점
	...
	public static void main(String[] args) throws Exception {
		...
		TreeMap rank = new TreeMap(new Comparator() {
			public int compare(Object o1, Object o2) {
				 ...
				 * (1) 알맞은 코드를 넣어 완성하시오.
				 */
				if(o1 instanceof SutdaDeck && o2 instanceof SutdaDeck) {
					Player2 p1=(Player2)o1;
					Player2 p2=(Player2)o2;
				
					return p2.point-p1.point;//점수 기준으로 내림차순으로 정렬
				}
...
class Player2 {
	...
	Player2(String name, SutdaCard c1, SutdaCard c2) {
		this.name = name;
		this.c1 = c1;
		this.c2 = c2;
	}
